...
// Treeview activation stuff:
 $(document).ready(function(){
   if(3 == <?php echo $GLOBALS['concurrent_layout'] ?>){
    ...
    $("#navigation-slide > li  > a#pat0").prepend('<img src="../../images/patient.png" class="nav-menu-img" />');
    $("#navigation-slide > li  > a#app0").prepend('<img src="../../images/patient.png" class="nav-menu-img" />');
    $("#navigation-slide > li  > a#rep0").prepend('<img src="../../images/reports.png" class="nav-menu-img" />');
    $("#navigation-slide > li  > a#fee0").prepend('<img src="../../images/fee.png" class="nav-menu-img" />');
    //$("#navigation-slide > li  > a#adm0").prepend('<img src="../../images/inventory.png" class="nav-menu-img" />');
    //$("#navigation-slide > li  > a#inv0").prepend('<img src="../../images/inventory.png" class="nav-menu-img" />');
    $("#navigation-slide > li  > a#adm0").prepend('<img src="../../images/admin.png" class="nav-menu-img" />');
    $("#navigation-slide > li  > a#mis0").prepend('<img src="../../images/misc.png" class="nav-menu-img" />');
    $("#navigation-slide > li  > a#pro0").prepend('<img src="../../images/procedures.png" class="nav-menu-img" />');
...
<?php
$tree = new menu();
echo $tree->buildMenu("main_menu", "navigation-slide");
?>
