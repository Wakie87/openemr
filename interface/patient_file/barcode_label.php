...
$pdf = new mPDF('', 'A4', '', '', 15, 15, 16, 16, 9, 9, 'L'); // set the orentation, unit of measure and size of the page
$pdf->AddPage(); 
...
$bobj = $barcode->getBarcodeObj('C128', '0123456789', '', '', 'black', array(0, 0, 0, 0));
$bc = $bobj->getHtmlDiv();
$pdf->WriteHTML($bc);
